...
#	InstantiationError
	...
	>>> pf = PixelFormatBgr24()
	>>> pf
	ddjvu.PixelFormatBgr24()
	>>> pf.bpp
	24

	>>> pf = PixelFormatRgb24()
	>>> pf
	ddjvu.PixelFormatRgb24()
	>>> pf.bpp
	24
...
#	InstantiationError
	...
	>>> pf
	ddjvu.PixelFormatRgbMask16(0xdead, 0xbeaf, 0x06b5, 0x1092)
	>>> pf.bpp
	16

	>>> pf = PixelFormatRgbMask32(424242, 3735928559, 171717, 373737)
	>>> pf
	ddjvu.PixelFormatRgbMask32(0x00067932, 0xdeadbeef, 0x00029ec5, 0x0005b3e9)
	>>> pf.bpp
	32
...
#	InstantiationError
	...
	>>> pf
	ddjvu.PixelFormatMsbToLsb()
	>>> pf.bpp
	1
	
	>>> pf = PixelFormatLsbToMsb()
	>>> pf
	ddjvu.PixelFormatLsbToMsb()
	>>> pf.bpp
	1
	'''
