...
class PixelFormatTest:
	...
	>>> pf = PixelFormatRgb()
	>>> pf
	decode.PixelFormatRgb(byte_order = 'RGB', bpp = 24)
	>>> pf = PixelFormatRgb('RGB')
	>>> pf
	decode.PixelFormatRgb(byte_order = 'RGB', bpp = 24)
	>>> pf = PixelFormatRgb('BGR')
	>>> pf
	decode.PixelFormatRgb(byte_order = 'BGR', bpp = 24)

	>>> pf = PixelFormatRgbMask(57005, 48815, 1717, 4242, 16)
	>>> pf
	decode.PixelFormatRgbMask(red_mask = 0xdead, green_mask = 0xbeaf, blue_mask = 0x06b5, xor_value = 0x1092, bpp = 16)

	>>> pf = PixelFormatRgbMask(424242, 3735928559, 171717, 373737, 32)
	>>> pf
	decode.PixelFormatRgbMask(red_mask = 0x00067932, green_mask = 0xdeadbeef, blue_mask = 0x00029ec5, xor_value = 0x0005b3e9, bpp = 32)

	>>> pf = PixelFormatGrey()
	>>> pf
	decode.PixelFormatGrey(bpp = 8)
